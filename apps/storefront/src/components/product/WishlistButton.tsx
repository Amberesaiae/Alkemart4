  ...
  return (
    <button
      ...
      className={cn(
        ...
        onMedia
          ? "h-8 w-8 rounded-full bg-white/90 text-muted-foreground shadow-sm hover:text-primary"
          : "h-8 w-8 rounded-full text-muted-foreground hover:bg-muted hover:text-primary",
        on && "text-primary",
        className,
      )}
    >
