...
export function AuthSplitLayout({
  ...
  return (
    ...
    >
      <aside className="relative hidden h-full min-h-0 overflow-hidden bg-[#faf8f2] md:flex md:flex-col">
        ...
        <div className="relative z-10 px-10 pt-10 lg:px-12 lg:pt-12">
          ...
          {caption ? (
            <p className="mt-2.5 text-sm font-medium text-foreground/55">
              {caption}
            </p>
          ) : null}
        </div>
        ...
        {brandFooter ? (
          <div className="relative z-10 px-10 pb-10 text-xs text-foreground/45 lg:px-12 lg:pb-12">
            {brandFooter}
          </div>
        ) : null}
      </aside>
