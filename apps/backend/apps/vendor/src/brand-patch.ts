...
const LOGO_SRC = "/seller/logo.svg"
...
function enhanceLoginBrand() {
  ...
  if (hint instanceof HTMLElement) {
    ...
    if (/mercur|medusa|Log in to your seller|Sign in to manage/i.test(t)) {
      hint.textContent = "Products, offers, and orders for your store."
    }
  }
}
