...
/**
 * Normalize any Ghana mobile input to 0-prefixed local MSISDN ("0509913229").
 * This is the form Paystack's mobile_money recipient/charge APIs accept —
 * E.164 ("+233…") is rejected with "Account number is invalid".
 * Returns null when no 9-digit NSN is derivable.
 */
export function toLocalMsisdn(phone: string): string | null {
