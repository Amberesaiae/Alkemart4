    ...
    >
      ...
      <Container className="relative z-10 grid grid-cols-2 gap-x-6 gap-y-8 pb-10 pt-12 sm:gap-x-8 lg:grid-cols-5 lg:gap-10">
        ...
        <div className="col-span-2 space-y-3 lg:col-span-1">
          ...
          <p className="type-sm font-bold uppercase tracking-wider text-slate-400">
            Payment method
          </p>
        ...
        <FooterCol title="Shop">
          ...
          <a
            href="/#last-offers"
            className="inline-flex min-h-11 items-center text-sm text-slate-300 transition hover:text-white focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-ink"
          >
            Last offers
          </a>
      ...
      <div className="relative z-10 border-t border-white/10 bg-black/20">
        <Container className="flex flex-col gap-1 py-4 text-center text-sm text-slate-400 sm:flex-row sm:justify-between sm:text-start">
          <span>
