...
const ROUTES: {
  ...
  },
  {
    ...
    title: "About Us",
    description:
      "About alkemart — Ghana multi-vendor marketplace. Compare multi-seller prices and shop with cash on delivery.",
    path: "/about",
  },
  {
    match: (p) => p === "/contact",
    title: "Contact Us",
    description:
      "Contact alkemart for shopper support, seller onboarding, and marketplace questions.",
    path: "/contact",
  },
  {
    match: (p) => p === "/help",
