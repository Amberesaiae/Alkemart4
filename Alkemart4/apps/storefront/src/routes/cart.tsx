    ...
    <div className="space-y-6 pb-8">
      ...
      {isLoading ? (
        <div className="space-y-3" role="status" aria-label="Loading cart">
          ...
          <Skeleton className="h-24 w-full rounded-lg" />
          <Skeleton className="h-40 w-full rounded-lg lg:w-80" />
        </div>
      ) : null}
      ...
      {items.length > 0 ? (
        <div className="grid gap-8 lg:grid-cols-[1fr_300px]">
          <div className="space-y-6">
            {multiSeller ? (
              <p className="rounded-lg border border-primary/30 bg-muted px-4 py-3 text-xs leading-relaxed text-foreground">
            ...
            {groups.map((group) => (
              <section
                key={group.key}
                className="space-y-3 rounded-lg border border-border bg-card p-4 shadow-sm sm:p-5"
              >
...
function CartLineRow(props: {
  ...
  return (
    <li className="flex flex-wrap items-center gap-3 rounded-lg border border-border/80 bg-background p-3 sm:p-4">
