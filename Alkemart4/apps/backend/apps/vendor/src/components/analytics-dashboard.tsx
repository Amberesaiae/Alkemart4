  ...
  return (
    <div className="alk-page">
      <header className="alk-page-header">
        <div>
          <div className="alk-badge alk-badge-spaced">alkemart · Seller Hub</div>
      ...
      {error ? (
        <div className="alk-error" role="alert">
          {error}
          <div className="alk-error-detail">
      ...
      {data?.readiness && data.readiness.phase !== "active" ? (
        <AlkBanner
          title={`Setup: ${data.readiness.phase.replace(/_/g, " ")}`}
          body={`${data.readiness.next_action?.label || "Finish pack address + delivery fee first."}${
      ...
      {data && !loading ? (
        <>
          ...
          <div className="alk-chart-grid">
            <section className="alk-chart-card alk-chart-card-wide">
              <h2>Orders & sales (30 days)</h2>
              <p className="alk-chart-sub">
                Your shop only · bars = orders · yellow = sales total (GMV)
              </p>
              <div className="alk-chart-body alk-chart-body-tall">
