...
const defaultOptions: FulfillmentOption[] = [
  { key: "shipping", label: "Shipping", sub: "Arrives Mon, Jul 6", price: "Free" },
  { key: "pickup", label: "Pickup", sub: "Ready today", price: "Free" },
  { key: "delivery", label: "Delivery", sub: "As fast as 1 hour", price: "GH₵9.95" },
];
