...
const methods = [
  {
    ...
    detail:
      "Supported lab path: pay the courier in cash when your order arrives. No charge is made up front.",
  },
  {
    name: "Mobile Money (lab only)",
    detail:
      "Paystack MoMo exists as an unfinished lab path (opt-in flag). Not production-complete — not shown at checkout unless lab mode is enabled.",
  },
];
