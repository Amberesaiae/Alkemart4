...
/** Big currency integer with superscript cents. Default = live market symbol. */
export function PriceCents({
  ...
  if (now == null || now === "") {
    return <div className={cn("h-8 w-28 animate-pulse rounded bg-muted", className)} aria-hidden />;
  }
