...
async function main() {
  ...
  const vendors = await Promise.all([
    ...
    upsertVendor({ slug: "goldstar-electronics", name: "Goldstar Electronics", bio: "Accra-based electronics retailer.", badgeFastShipper: true }),
  ...
  await db.insert(homepageSectionsTable).values([
    ...
    },
    {
      ...
      config: {
        ...
        title: "Same-hour delivery across Accra",
        cta: "Shop deals",
      },
    },
    {
